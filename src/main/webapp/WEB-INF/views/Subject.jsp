    ...
    <div>
        ...
        <div class="row justify-content-center form-group">
            <div class="col-md-8 col-sm-8 col-xs-8 col-xs-offset-2 col-md-offset-2 col-sm-offset-2 bg-white border rounded">
                ...
                <form action="/23_SpringSecurity_Assignment1/saveSubject" method="post">
                    <div class="alert mt-3 alert-primary" role="alert">
                        ${message}
                    </div>
                ...
                <div class="row form-group"></div>
                <form action="/23_SpringSecurity_Assignment1/searchSubject" method="post">
                <div class="input-group mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <a class="btn btn-danger" href="/23_SpringSecurity_Assignment1/subjects">Clear Search</a> 
                    </div>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                		...
                		<tr>
                    		...
                    		<td>
                        		<a href="/23_SpringSecurity_Assignment1/deleteSubject?subjectId=${subject.subjectId}">Delete</a>
                    		</td>
